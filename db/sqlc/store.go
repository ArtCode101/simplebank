...
// TransferTxParam contains the input parameters of the transfer transacton
...
// It creates a transfer record, add account entries, and update accounts' balance within a single databas transaction
